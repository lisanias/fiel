...
class IdentidadeController extends Controller
{
    ...
    {
        $identidades = Identidade::orderBy('created_at', 'DESC', SORT_REGULAR, true)->paginate(10);
        return view('identidade.index', compact('identidades'));
    }
    ...
    public function show($id)
    {
        ...
        $igreja = Igreja::find($identidade->member->igreja_id);
        //dd($igreja);
